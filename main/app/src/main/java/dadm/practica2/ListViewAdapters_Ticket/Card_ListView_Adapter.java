...
public class Card_ListView_Adapter extends BaseAdapter {
    ...
    //CONSTRUCTOR
    public Card_ListView_Adapter(Context context, ArrayList<DtoTicket> array) {
        super();
        mContext=context;
        arrayTickets=array;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        view = inflater.inflate(R.layout.card_itemlist, null);

        // get the reference of textViews
        img = (ImageView) view.findViewById(R.id.img);
        textViewTitle = (TextView)view.findViewById(R.id.titleCard);
        textViewDesc = (TextView)view.findViewById(R.id.descList);
        textViewPrice = (TextView)view.findViewById(R.id.priceCard);
        ...
        textViewPrice.setText(Double.toString(arrayTickets.get(position).getPrecio()));
        ocr.setText(arrayTickets.get(position).getOcr());
